...
console.log(Number('23')); // both output is 23
console.log(+'23');

// Parsing //Number is name space
console.log(Number.parseInt('30px'));

// Check if value is NaN
console.log(Number.isNaN(20)); // false because it is number
console.log(Number.isNaN('20')); // false because it is number even it's string
console.log(Number.isNaN(+'20X')); // True becasue it is not a number.
